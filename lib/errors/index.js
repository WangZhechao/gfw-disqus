var path = require('path'),
	...
	DisqusRequestError = require('./disqus-request-error'),
	errors;
...
errors = {
    ...
    disqusRequestError: function(err) {

    	var code = 500,
    		statusCode = err.statusCode || 500,
    		message = err.message || 'DisqusRequestError';
...
module.exports.DisqusRequestError = DisqusRequestError;